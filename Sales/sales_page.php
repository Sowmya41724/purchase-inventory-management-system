...
<body>
    ...
    <div class="input-container">
        <button onclick="location.href='edit_sales.php'" type="button">&#8618; Database</button>
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="salesForm">
